/* ============================================================
   United States - Stacked Challenge 3
...
window.MAP_CHALLENGE_CONFIG = {
  ...
  ui: {
    bannerTitle: "UNITED STATES STACKED CHALLENGE 3",
    bannerAria: "United States stacked map challenge 3 banner",

    mainAria: "United States stacked map challenge 3",
    mapAria: "United States map",

    overlayKicker: "STACKED MAP CHALLENGE",
    overlayTitle: "UNITED STATES | LEVEL 3",
    beginMessage: "Southeast + Mid-Atlantic + New England + Midwest",
