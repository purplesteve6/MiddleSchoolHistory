/* ============================================================
   United States - Stacked Challenge 5
...
window.MAP_CHALLENGE_CONFIG = {
  ...
  ui: {
    bannerTitle: "UNITED STATES STACKED CHALLENGE 5",
    bannerAria: "United States stacked map challenge 5 banner",

    mainAria: "United States stacked map challenge 5",
    mapAria: "United States map",

    overlayKicker: "STACKED MAP CHALLENGE",
    overlayTitle: "UNITED STATES | LEVEL 5",
    beginMessage: "Southeast + Mid-Atlantic + New England + Midwest + Great Plains + Southwest",
