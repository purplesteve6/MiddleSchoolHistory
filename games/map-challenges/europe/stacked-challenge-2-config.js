...
window.MAP_CHALLENGE_CONFIG = {
  ...
  ui: {
    bannerTitle: "EUROPE STACKED CHALLENGE 2",
    bannerAria: "Europe stacked map challenge 2 banner",

    mainAria: "Europe stacked map challenge 2",
    mapAria: "European countries map",

    overlayKicker: "STACKED MAP CHALLENGE",
    overlayTitle: "EUROPE | LEVEL 2",
    beginMessage: "Balkan + Central + Eastern",
