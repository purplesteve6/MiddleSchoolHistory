...
window.MAP_CHALLENGE_CONFIG = {
  ...
  ui: {
    bannerTitle: "EUROPE STACKED CHALLENGE 3",
    bannerAria: "Europe stacked map challenge 3 banner",

    mainAria: "Europe stacked map challenge 3",
    mapAria: "European countries map",

    overlayKicker: "STACKED MAP CHALLENGE",
    overlayTitle: "EUROPE | LEVEL 3",
    beginMessage: "Balkan + Central + Eastern + Scandinavia",
