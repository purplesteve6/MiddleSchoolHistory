...
**Southwest landing-page image pass (2026-09-22):** the overview now uses the user-supplied Monument Valley landscape in the hero, an Edward S. Curtis horse/rider image in the horse feature, and four full teaching diagrams for hogan, wickiup, cliff dwellings, and Pueblo/adobe architecture. The home diagrams are displayed as coordinated 2×2 teaching cards and link to their full-size WEBP files.

**Diné layout cleanup (2026-09-22):** removed the redundant early Horseshoe Bend image and rebuilt the sheep / weaving / trade material as three uniform image-topped cards so each supplied image sits directly with its associated concept.
